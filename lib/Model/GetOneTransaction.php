...
/**
 * GetOneTransaction Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetOneTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOneTransaction';
    ...
    protected static $openAPITypes = [
        ...
        'currency' => 'string',
        'created_at' => 'string',
        'transaction_status' => '\OpenAPI\Client\Model\TransactionStatusEnum',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_done', $data ?? [], null);
        $this->setIfExists('is_escrow', $data ?? [], null);
        $this->setIfExists('is_merchant', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['amount_to_pay'] === null) {
            $invalidProperties[] = "'amount_to_pay' can't be null";
        }
        ...
        if ($this->container['is_escrow'] === null) {
            $invalidProperties[] = "'is_escrow' can't be null";
        }
        if ($this->container['is_merchant'] === null) {
            $invalidProperties[] = "'is_merchant' can't be null";
        }
     ...
     * Sets amount_to_pay
     *
     * @param int $amount_to_pay amount_to_pay
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\TransactionStatusEnum
     */
     ...
     *
     * @param \OpenAPI\Client\Model\TransactionStatusEnum $transaction_status transaction_status
     *
     * @return self
     */
     ...
     * Sets is_escrow
     *
     * @param bool $is_escrow is_escrow
     *
     * @return self
     */
     ...
     * Sets is_merchant
     *
     * @param bool $is_merchant is_merchant
     *
     * @return self
     */
